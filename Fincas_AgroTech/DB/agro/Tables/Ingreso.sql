...
GO
CREATE NONCLUSTERED INDEX [IX_Ingreso_EsAutomatico]
    ON [agro].[Ingreso]([EsAutomatico] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_Ingreso_OrigenModulo]
    ON [agro].[Ingreso]([OrigenModulo] ASC, [ReferenciaOrigenId] ASC);
